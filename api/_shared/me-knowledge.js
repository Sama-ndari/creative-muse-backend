...
188. How to contact me [TYPE:PROJECT] [SECTION:CONTACT] [PRIORITY:HIGH] Answer: Email: cezaremardini10@gmail.com | WhatsApp: +257 77 568 903 | Location: Carama, Bujumbura, Burundi. Open for collaborations on Agentic AI, RAG Systems, and Backend Architecture. Contact form at samandari.dev/contact.html.
...
const PORTFOLIO_PROJECTS = `🚀 PART 21 — PORTFOLIO PROJECTS (samandari.dev)
...
204. Kirundi Contribution Platform [TYPE:PROJECT] [SECTION:AI] [PRIORITY:HIGH] Answer: Problem: Contributors need frictionless way to submit Kirundi sentences and audio. Architecture: Serverless — GitHub Pages frontend, Google Apps Script backend, zero hosting cost. Outcome: Live at samandari.dev/kirundi-contribution-app/, powers dataset growth.
...
206. SAMAKOD: URL to QR Generator [TYPE:PROJECT] [SECTION:UTILITY] [PRIORITY:MEDIUM] Answer: Problem: Quick QR codes without signup, backend, or internet. Architecture: Static HTML/CSS/JS, vendored QR library, canvas preview, PNG download. Outcome: sama-ndari.github.io/samakod and samandari.dev/samakod — works offline.
